...
class Sessions extends RESTResource {
    ...
    static function registerRoutes($app, $em, $beanstalk, $config, $messages) {
        $app->post('/api/sessions', function() use ($app, $em, $beanstalk, $config, $messages) {
            $controller = new Sessions($em, $beanstalk, $config);
        ...
        $app->delete('/api/sessions', function() use ($app, $em, $beanstalk, $config, $messages) {
            $controller = new Sessions($em, $beanstalk, $config);
