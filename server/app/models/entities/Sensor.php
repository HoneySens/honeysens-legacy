...
class Sensor {
	...
	/**
	 * @ManyToOne(targetEntity="HoneySens\app\models\entities\SensorConfig", inversedBy="sensors")
	 */
     ...
     * Set configuration
     *
     * @param \HoneySens\app\models\entities\SensorConfig $configuration
     * @return Sensor
     */
    public function setConfiguration(\HoneySens\app\models\entities\SensorConfig $configuration = null) {
     ...
     * Get configuration
     *
     * @return \HoneySens\app\models\entities\SensorConfig 
     */
	...
	public function getState() {
		...
		$cert_fp = $this->getCert() ? $this->getCert()->getFingerprint() : '';
		...
		return array(
			...
			'cert' => $cert,
			'cert_fp' => $cert_fp,
			'config' => $this->getConfiguration()->getId(),
			'update_interval' => $this->getConfiguration()->getUpdateInterval(),
