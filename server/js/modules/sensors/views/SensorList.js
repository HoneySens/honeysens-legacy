        ...
        Views.SensorList = Marionette.LayoutView.extend({
                            ...
                            events: {
                                'change input[type="checkbox"]': function(e) {
                                    ...
                                    if($(e.target).is(':checked')) {
                                        if(!_.contains(_.pluck(services, 'service'), service.id)) services.push({service: service.id, revision: null});
                                    } else {
                                        services = _.without(services, _.find(services, function(s){return s.service == service.id}));
                                    }
            ...
            templateHelpers: {
                hasFirmware: function() {
                    return HoneySens.data.models.defaultconfig.get('image') != null;
                },
