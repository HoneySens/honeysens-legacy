<div class="col-sm-12">
    ...
    <dl class="dl-horizontal label-left nooverflow">
        ...
        <dt>Entwicklung</dt>
        <!--<dd>Pascal Brückner</dd>-->
        <dd>T-Systems Multimedia Solutions</dd>
        <dt>Website</dt>
        <dd><a href="https://honeysens.de/">honeysens.de</a></dd>
    </dl>
    <div class="well">
        ...
        Administratoren dabei unterstützt, die Bedrohungslage innerhalb einer komplexen Netzarchitektur in kurzer Zeit
            ...
            <div id="documentation" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <p><a href="docs/admin_manual.pdf" target="_blank">Administrationshandbuch</a>
                        <br />Beschreibt Installation und Updates für Server in Version 0.2.x</p>
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            ...
            <div id="releasenotes" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <p>UI-Modul hinzugefügt mit allgemeinen Daten über das HoneySens-Projekt, Dokumentation und Changelogs.
                        Außerdem eine Reihe von Bugfixes im Frontend.</p>
                    <hr />
                    <span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;<strong>Revision 0.2.4</strong><br/>
                    <p>Simultanes Bearbeiten oder Entfernen mehrerer Ereignisse ermöglicht, außerdem zahlreiche Bugfixes.</p>
                </div>
            </div>
        </div>
    </div>
