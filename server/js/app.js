define(['app/views/RootLayout', 'marionette', 'backbone', 'jquery', 'json', 'underscore'],
		...
		app.commands.setHandler('fetchUpdates', function() {
			...
			$.ajax({
				...
				success: function(data) {
					...
					if(_.has(data, 'configs')) {
						app.data.models.configs.fullCollection.reset(data.configs);
						app.data.models.defaultconfig.set(data.defaultconfig);
					}
					if(_.has(data, 'images')) app.data.models.images.reset(data.images);
					...
					if(_.has(data, 'contacts')) app.data.models.contacts.reset(data.contacts);
                    if(_.has(data, 'services')) app.data.models.services.reset(data.services);
