...
while True:
    ...
    sensor_config.add_section('services')
    ...
    sensor_config.set('server', 'certfile', '/opt/honeysens/server-cert.pem')
    sensor_config.set('general', 'sensor_id', job_data['id'])
    sensor_config.set('general', 'hostname', job_data['hostname'])
    sensor_config.set('general', 'certfile', '/opt/honeysens/cert.pem')
    sensor_config.set('general', 'keyfile', '/opt/honeysens/key.pem')
    sensor_config.set('general', 'sw_version', job_data['sw_version'])
    sensor_config.set('network', 'interface', 'eth0')
    ...
    sensor_config.set('services', 'recon', False)
    sensor_config.set('services', 'kippo', False)
    sensor_config.set('services', 'dionaea', False)
